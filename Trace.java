...
public class Trace {
	final static int threadnum = 32; // concurrent thread number
	final static int routenum = 5;//3; // route is designed from 1 to 3
	final static int coachnum = 8;//3; // coach is arranged from 1 to 5
	final static int seatnum = 100;//3; // seat is allocated from 1 to 20
	final static int stationnum = 10;//3; // station is designed from 1 to 5
